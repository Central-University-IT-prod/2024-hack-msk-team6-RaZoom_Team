...
def create_app(
    ...
    logging.getLogger("uvicorn.access").addFilter(LoggingFilter(root_path, ignoring_log_endpoints))
...
class LoggingFilter(logging.Filter):
    def __init__(self, root_path: str, ignoring_log_endpoints: list[tuple[str, str]]) -> None:
        super().__init__()
